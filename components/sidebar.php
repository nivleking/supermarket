        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="order.php" class="flex items-center p-2 <?php echo (basename($_SERVER['PHP_SELF']) == 'order.php') ? 'text-black' : 'text-gray-300'; ?> rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Order Analysis</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
